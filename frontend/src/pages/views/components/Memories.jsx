      ...
      <LayoutView>
        <div className='pb-8'>
          ...
          <div className='lg:justify-between lg:flex-row lg:items-center flex flex-col gap-2'>
            <h2 className='sm:text-6xl text-3xl font-bold leading-snug tracking-tighter'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 *:px-6 -mx-6 overflow-hidden divide-neutral-200 lg:divide-x-2'>
          <img
          ...
          <img
            ...
            alt=''
            draggable={false}
            className=' lg:my-0 object-cover max-w-full max-h-full my-4'
          />
          <img
