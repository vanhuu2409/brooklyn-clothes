                  ...
                  <div className='gap-14 flex flex-1 h-full max-h-full px-20 py-12'>
                    ...
                    <ul className='flex flex-col gap-3'>
                      ...
                      <ul className='flex flex-col justify-center gap-3 *:capitalize *:font-normal *:text-black-3'>
                        {["t-shirts", "hoodies", "sweaters", "jackets"].map(
                          (item, index) => (
                            <li key={index}>
                              <Link
                        ...
                        <li>
                          <Link
                            to='/products'
                            className='hover:opacity-70 p-2 font-bold transition-all'
                          >
                            View all
                          </Link>
                        </li>
            ...
            >
              <li className='relative'>
                ...
                <svg
                  ...
                  strokeWidth={4}
                  stroke='currentColor'
                  className={`w-3 h-3 peer-checked:rotate-90 transition-all duration-300 absolute top-6 right-0`}
                >
                  <path
                    strokeLinecap='round'
                    strokeLinejoin='round'
                ...
                <label
                  htmlFor='shop-toggle'
                  className='max-h-14 absolute inset-0 cursor-pointer'
                ></label>
                {/* sub presets menu */}
                <ul
                  className={`flex flex-col overflow-hidden transition-all duration-300 peer-checked:max-h-96 max-h-0 gap-2 *:text-lg pt-2  pl-4 *:pt-2 divide-y *:capitalize *:font-normal *:tracking-widest divide-neutral-700 antialiased`}
                >
              ...
              {["Collections", "News", "About"].map((item) => (
