  ...
  return (
    <footer className=' bg-white'>
      <div className='container py-12 mx-auto'>
        <div className='sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4 grid grid-cols-1 gap-6'>
          ...
          <div>
            ...
            <div className='flex flex-col items-start mt-5 space-y-2'>
              <Link
                to='/'
                className=' hover:text-black-4 text-black-2 transition-colors duration-300'
              >
                Home
              </Link>
              <Link
        ...
        <div className='flex items-center justify-between'>
          <Link
            to='/'
            className='drop-shadow-md hover:text-black-4 w-full py-4 text-2xl font-extrabold text-left uppercase transition-all'
          >
            brooklyn
          </Link>
          ...
          <div className='flex -mx-2'>
            <Link
              to='/'
              className=' hover:text-black-4 text-black-2 mx-2 transition-colors duration-300'
              aria-label='Reddit'
            >
              <svg
